...
/* 
  * 根据12种状态把 app 分为四类：appsToUnload(待卸载)，appsToUnmount（待卸载），appsToLoad（待加载），appsToMount（待装载）
...
/* 
  * 获取当前被激活的应用名称数组
  * apps.filter(app => app.activeWhen(location)).map(app => app.appName)
 */
